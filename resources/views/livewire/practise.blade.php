                        ...
                        @if($this->participation->participate)
                            <div>
                                <div class="grid grid-cols-2 mt-4">
                                    ...
                                    <button x-on:click="@this.call('noDrive')" style="display: none"  x-show="showDrive" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded inline-flex">
